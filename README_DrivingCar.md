...
### Gameplay
*Top-down 2D driving with obstacle avoidance, score tracking, and increasing difficulty.*

### Game States
*Title screen, gameplay, pause menu, game over with high score persistence.*
...
- [GitHub Repository](https://github.com/alfonsojose-go/DrivingCar)
